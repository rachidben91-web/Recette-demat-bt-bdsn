// js/main.js — DEMAT-BT v11.4.1 — 19/02/2026
// Point d'entrée principal
// FIX v11.2.0: renderAll alias, weather init, refreshAllViews
// FIX v11.4.1: Modal event listeners + loadBadgeRules() + loadBadgeRules avant cache

document.addEventListener('DOMContentLoaded', () => {
    console.log("🚀 DEMAT-BT v11.4.1 démarré.");
    ...
    // ── FIX v11.4.1 : Charger les règles badges AVANT la restauration du cache ──
    ...
    // ============================================================
    // 5. MODAL — Événements des boutons (FIX v11.4.1)
    // ============================================================
